 ...
 * - @subpage page_iface_org_kde_kwin_blur_manager - blur manager
 * - @subpage page_iface_org_kde_kwin_blur - blur interface
 ...
 * @section page_iface_org_kde_kwin_blur_manager_desc Description
 *
 * This interface allows a client to request blur behind a surface.
 ...
 * @section page_iface_org_kde_kwin_blur_desc Description
 *
 * This interface allows a client to set blur region.
 ...
 * @ingroup iface_org_kde_kwin_blur_manager
 *
 * Create a blur object for the given surface.
 */
 ...
 * @ingroup iface_org_kde_kwin_blur
 *
 * Apply the blur region to the surface.
 */
static inline void
 ...
 * @ingroup iface_org_kde_kwin_blur
 *
 * Set the region of the surface to be blurred.
 * If no region is set, the entire surface will be blurred.
 */
static inline void
